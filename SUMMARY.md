...
* [Compojure](compojure/index.md)
    * [Theory: routing](compojure/theory-routing.md)
    ...
    * [Theory: local name bindings](compojure/theory-local-name-bindings.md)
    * [Theory: using Clojure hash-maps](compojure/theory-using-hash-maps.md)
...
* [Server-side API](server-side-api/index.md)
    ...
    * [Unit Testing an API](server-side-api/testing-api.md)
        * [ring-mock library](server-side-api/ring-mock.md)
        *   [cheshire library](server-side-api/cheshire.md)
    * [Calling API's](calling-apis/index.md)
        * [Postman Client](calling-apis/postman.md)
        * [Curl Client](calling-apis/curl.md)
...
* [Work in Progress](work-in-progress.md)
    ...
    * [Project: URL Shortner as a Service](project-url-shortner/index.md)
    ...
    kk    * [add alias to database](project-url-shortner/add-alias-to-database.md)
        * [get alias from database](project-url-shortner/get-alias-from-database.md)
     kk   * [delete alias from database](project-url-shortner/delete-alias-from-database.md)
